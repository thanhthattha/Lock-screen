...
*/
  !(function (t, e, n, a) {
    ...
    function r(t) {
      ...
      o.push("</ul>"), e.html(o.join("")).css({ width: a[1] * (2 * i + 2 * r) + 2 * r + "px", height: a[0] * (2 * i + 2 * r) + 2 * r + "px" }), (t.pattCircle = t.holder.find(".patt-circ"));
    }
    function i(t, e, n, a) {
      var r = e - t,
        i = a - n;
      return { length: Math.ceil(Math.sqrt(r * r + i * i)), angle: Math.round((180 * Math.atan2(i, r)) / Math.PI) };
    }
    function o() {}
    function s(e, n) {
      var a = this,
      ...
      h = function (e, n) {
        ...
        if (u) {
          if (-1 == l.indexOf(c)) {
            ...
            if (o.lastPosObj) {
              for (
                var g = o.lastPosObj, x = g.i, w = g.j, b = Math.abs(h.i - x), j = Math.abs(h.j - w);
            ...
            if (1 != l.length) {
              ...
              o.line.css({ width: D.length + 10 + "px", transform: "rotate(" + D.angle + "deg)" }), d || o.line.show();
            }
    ...
    (o.prototype = {
      ...
      getIdxFromPoint: function (t, e) {
        var n = this.option,
          ...
          h = r % l,
          u = i % l;
        return p <= a[1] && d <= a[0] && h > 2 * s && u > 2 * s && (o = (d - 1) * a[1] + p), { idx: o, i: p, j: d, x: r, y: i };
      },
    }),
      (s.prototype = {
        constructor: s,
      ...
      (s.defaults = { matrix: [3, 3], margin: 20, radius: 25, patternVisible: !0, lineOnMove: !0, enableSetPattern: !1 }),
      (e.PatternLock = s);
